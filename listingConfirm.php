 ...
 <div class="w3-row-padding w3-padding-64 w3-container" <div class="w3-padding-64 w3-container" style="background-image: url(./madison.jpg); background-size: cover;">
  <div class="w3-content">
    <div class="w3-container w3-white" style="padding: 1em; opacity:.875">
	  ...
	  <tr>
	  <td>
	  <h4 class='w3-padding-24' align='center'> Listing uploaded successfully! <br> Make sure to check your My Listings page to upload the images needed for your post.</h4>
	  <p class="w3-text-grey"> You will now be redirected back to the action Page. </p>
	  <?php echo "<META HTTP-EQUIV=\"refresh\" content=\"5; URL=decisionPage.php\"> "; ?>
	  </td>
    </div>
	</tr></table>
  </div>
